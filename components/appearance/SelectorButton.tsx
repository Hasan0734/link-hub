  ...
  return (
    <div className="w-full text-center space-y-1 ">
      <div className="relative group">
        {isPro && (
          <button className="group inline-flex items-center justify-between overflow-hidden rounded-[4rem] bg-black px-1.5 py-0.5 text-xs font-semibold text-white opacity-50 hover:opacity-100 absolute right-2 top-2 z-10 bg-opacity-50">
            ...
            >
              <path
                fill="currentColor"
                d="M8.5.5v6H13l-5.5 9v-6H3l5.5-9Z"
              ></path>
              <path
                fill="currentColor"
        ...
        <Button
          ...
          className={cn("w-full rounded-2xl h-12 ring-offset-1 ring-primary", {
            "ring-2": state === keyValue,
          })}
          variant={"secondary"}
          size={"lg"}
        >
